...
ITEMS=(
    docker-tags/dangerous_deer/compilation/assets/grass-7.4.1/grass-7.4.1.tar.gz
    docker-tags/gargantuan_giraffe/010_compilation/assets/grass-7.8.3/grass-7.8.3.tar.gz
    docker-tags/jelly_jealous/010_compilation/assets/grass/grass-8.3.0.tar.gz
    docker-tags/jelly_jealous/010_compilation/assets/hadoop-spark/hadoop-3.3.6.tar.gz
    docker-tags/jelly_jealous/010_compilation/assets/hadoop-spark/spark-3.4.1-bin-hadoop3.tgz
)
